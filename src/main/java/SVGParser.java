...
public class SVGParser
{
	...
	public static ArrayList<Path> parseFile(File f) throws ParserConfigurationException, SAXException, IOException 
	{
		...
		for (int i = 0; i < paths.getLength(); i++)
		{
			...
			out.add(parseList(svgToList(d), id));
		}
		
		return out;
	}
		
	private static ArrayList<ArrayList<Object>> svgToList(String path) throws IOException
	{
...
*/				case 'Z':
	...
	public static void appendToPath(ArrayList<ArrayList<Object>> commands, Path out)	//come up with better name
	{
		for (ArrayList<Object> command : commands)
		{
			Double x2 = 0.0;
